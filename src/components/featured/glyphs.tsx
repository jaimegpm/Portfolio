import type { Provider } from '@/data/eclipsecode'
...
function Glyph({ size = 13, className, children }: GlyphProps & { children: React.ReactNode }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" className={`shrink-0 ${className ?? ''}`} {...stroke}>
      {children}
    </svg>
  )
}
...
export const MaximizeGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
    <path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" />
  </Glyph>
)

export const MinimizeGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
...
export const PanelRightGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
    <rect x="3" y="4" width="18" height="16" rx="2" />
    <path d="M15 4v16M11 10l-2 2 2 2" />
  </Glyph>
)

export const NewChatGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
...
export const GearGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
...
export const PenGlyph = (p: GlyphProps) => (
  <Glyph {...p}>
...
function CodexMark({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" className="shrink-0" fill="currentColor" fillRule="evenodd">
...
function GrokMark({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="56 56 400 400" aria-hidden="true" className="shrink-0" fill="currentColor">
...
const MARKS: Record<Provider, (size: number) => React.ReactNode> = {
  claude: (size) => <ClaudeMark size={size} />,
  codex: (size) => <CodexMark size={size} />,
  grok: (size) => <GrokMark size={size} />,
}

export function ProviderMark({ provider, size = 13 }: { provider: Provider; size?: number }) {
  return <>{MARKS[provider](size)}</>
}
