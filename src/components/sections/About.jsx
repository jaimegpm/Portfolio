          ...
          <div className="about__text">
            ...
            <div className="about__info-container bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 mb-8">
              ...
              <div className="about__info space-y-4">
                <div className="about__info-row flex flex-col sm:flex-row sm:gap-4">
                  <div className="about__info-item flex items-center mb-3 sm:mb-0 flex-1 min-w-0">
                    <div className="about__info-icon-wrapper mr-3 p-1.5 bg-gray-100 dark:bg-gray-700 rounded-full flex-shrink-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span className="about__info-value text-gray-900 dark:text-white text-sm truncate block">
                        {t('about.name')}
                      </span>
                    </div>
                  </div>
                  
                  <div className="about__info-item flex items-center flex-1 min-w-0">
                    <div className="about__info-icon-wrapper mr-3 p-1.5 bg-gray-100 dark:bg-gray-700 rounded-full flex-shrink-0">
                      <svg className="w-4 h-4 text-primary dark:text-primary-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="about__info-row flex flex-col sm:flex-row sm:gap-4">
                  <div className="about__info-item flex items-center mb-3 sm:mb-0 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span className="about__info-value text-gray-900 dark:text-white text-sm block">
